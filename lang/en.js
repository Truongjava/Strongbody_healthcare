...
export const transMailRemedy= {
    ...
    template: (data) => {
        return `<h3>Thank you for your trust in booking a medical examination in Strongbody DoctorCare's system.</h3>
        After you have seen the doctor's office <b> ${data.doctor} </b>, you can review the billing details from this email attachment. </h4>
        <br>
        <div>In the event of neither receiving attachments nor decompressing, please contact the support operator <b>113</b></div>
        <h4>Thank you !</h4>`;
    },
};
