    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (schedule && schedule.sumBooking < schedule.maxBooking) {
                ...
                // fix lỗi placeId = 'none' => null
                if (data.placeId === 'none' || !data.placeId) {
                    data.placeId = null;
                }
